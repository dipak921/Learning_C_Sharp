...
//--> Abstract Class : it cannot instantiated and implemention must be provided in derived class to use it.
//Can have bot Abstract and Non-Abstract Methods. WAP to show example of Abstradt Mehtod and class.
//                   - The word abstract means a concept or an idea not associated with any specific instance.
//                   In porgraming we apply the same meaning of abstraction by making classes not associated with any specific instance.
...
//                   -5. Like any other class, an abstracto class can contain fields that describe the characteristics and methods that
//                   describe the actions that a class can perfrom.
